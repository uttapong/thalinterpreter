...
exports.interprete = function(req,type) {
	...
	if(data.hbcs.toString().toLowerCase()=='found')data.hbcs=1;
	if(data.bart_h.toString().toLowerCase()=='found')data.bart_h=1;
			...
			if(data.bart_h>0){
				...
				if(data.hbcs>0){
					...
					if(isMCH)
					{
						...
						else if(data.mcv<75 && data.mch<25)result= 'ALPHA_THAL1_TRAIT';
					}
					if(!isMCH){
						if(data.mcv>=85 )result= 'NORMAL_HB';
						else if(data.mcv<75)result= 'ALPHA_THAL1_TRAIT';
					}
