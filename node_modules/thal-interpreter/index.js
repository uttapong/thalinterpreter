...
//	var liveresult={};
	...
	if(data.f>60){
		...
		//	console.log('-----------------------------------Possible Beta thal');
				...
				if(data.a2e<8&&(data.mcv<75 || data.mch<25))result= 'BETA_THAL';
			...
			if(data.a2e>=8){
				...
				//	console.log(data);
					...
					if(data.a2e>35){
						...
						if(suspect(data.a2e,75))boundary.push('hbe');
						if(data.a2e>75)result= 'HBE_HOMO';
						...
						if(data.a2e<25&&(data.mcv<=70 || (data.mch <25 && data.mch>0))){
							result= 'HBE_WITH_ALPHA_THAL1';
							if(suspect(data.a2e,25))boundary.push('hbe');
						}
						else if((data.a2e>20&&data.a2e<=35)&&(data.mcv>70 || data.mch>=25)){
							result= 'HBE_TRAIT';
							if(suspect(data.a2e,20))boundary.push('hbe');
						}
						else {
							result= 'FAIL_HBE';
							if(suspect(data.a2e,20))boundary.push('hbe');
